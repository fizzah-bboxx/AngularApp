import { PostService ,CommentService } from './../post.services';
...
export class PostListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.postService.posts.subscribe((data)=> this.posts = data as Dictionary[])
  ...
  SubmitPost(){
    ...
    if (resp['status']=='success'){this.posts.push(data); }
  ...
  getComments(postId:number){
    ...
    this.commentService.comments.subscribe((data)=> this.comments = data as Dictionary[])
