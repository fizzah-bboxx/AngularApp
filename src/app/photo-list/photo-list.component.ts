...
export class PhotoListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.galleryService.photos.subscribe((data) => this.photo_list = (data as Dictionary[]).slice(1,500))
  }

  getAlbum(albumId:number){
    this.galleryService.albumId = albumId;
    this.galleryService.album.subscribe((data) => this.album = data as Dictionary)
  }
